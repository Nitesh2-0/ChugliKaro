  ...
  return (
    <div className="w-screen flex items-center bg-gray-50 px-4 md:px-8 lg:px-12 py-3 md:py-2 shadow-md justify-between">
      ...
      <div className="flex items-center space-x-8">
        ...
        >
          <img
            src={authUser?.profilePic || avtar}
            alt="Profile"
            className="w-7 h-7 object-cover border-gray-100 border rounded-full"
          />
      ...
      <div
        className={`absolute top-16 right-2 z-50 transition-all duration-300 ease-in-out transform ${isProfileOpen ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`}
      >
